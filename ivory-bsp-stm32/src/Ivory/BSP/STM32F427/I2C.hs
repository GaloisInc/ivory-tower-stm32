...
module Ivory.BSP.STM32F427.I2C
  ( i2c1
  , i2c2
  , i2c3
  ) where
...
i2c1 = mkI2CPeriph i2c1_periph_base
          (rccEnable rcc_apb1en_i2c1)
          (rccDisable rcc_apb1en_i2c1)
          (rccReset rcc_apb1rst_i2c1)
...
i2c2 = mkI2CPeriph i2c2_periph_base
          ...
          (rccReset rcc_apb1rst_i2c2)
          I2C2_EV I2C2_ER "i2c2"

i2c3 :: I2CPeriph
i2c3 = mkI2CPeriph i2c3_periph_base
          (rccEnable rcc_apb1en_i2c3)
          (rccDisable rcc_apb1en_i2c3)
          (rccReset rcc_apb1rst_i2c3)
...
rccReset :: BitDataField RCC_APB1RSTR Bit -> Ivory eff ()
rccReset field = do
  modifyReg regRCC_APB1RSTR $ setBit field
  modifyReg regRCC_APB1RSTR $ clearBit field
