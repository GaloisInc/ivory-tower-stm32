...
uart2 = mkUART uart2_periph_base
                rccenable rccdisable
                F427.USART2 PClk1
                (UseDMA (DMAConfig dma1 6 4))   -- TODO: put in platform definition?
                "uart2"
  where
